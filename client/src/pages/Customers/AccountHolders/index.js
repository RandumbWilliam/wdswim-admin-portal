...
const AccountHolders = () => {
  ...
  return (
    <PageContainer>
      <Container>
        <CustomButton onClick={handleOpenModalAccountHodlers}>
          Add Account Holders
        </CustomButton>
        {/* <CustomButton 
          ...
          <CustomTable unstackable>
            <CustomTable.Header>
              <CustomTable.Row>
                ...
                <CustomTable.HeaderCell>AccountID</CustomTable.HeaderCell>
                <CustomTable.HeaderCell>Contact Name</CustomTable.HeaderCell>
                <CustomTable.HeaderCell>Phone Number</CustomTable.HeaderCell>
                <CustomTable.HeaderCell>Email</CustomTable.HeaderCell>
                <CustomTable.HeaderCell>Address</CustomTable.HeaderCell>
                <CustomTable.HeaderCell>City</CustomTable.HeaderCell>
                <CustomTable.HeaderCell>Postal Code</CustomTable.HeaderCell>
              ...
              {accountHoldersData.map((item, index) => (
                <CustomTable.Row key={index}>
                  <CustomTable.Cell>
                    <CustomButton
                      onClick={() => {
                        openAccountInfo(item.id);
                      }}
                    >
                      <FaPen />
                    </CustomButton>
                  </CustomTable.Cell>
                  <CustomTable.Cell>{item.id}</CustomTable.Cell>
                  <CustomTable.Cell>{item.contactName}</CustomTable.Cell>
                  <CustomTable.Cell>{item.phoneNumber}</CustomTable.Cell>
                  <CustomTable.Cell>{item.email}</CustomTable.Cell>
                  <CustomTable.Cell>{item.address1}</CustomTable.Cell>
                  <CustomTable.Cell>{item.city}</CustomTable.Cell>
                  <CustomTable.Cell>{item.postalCode}</CustomTable.Cell>
                  <CustomTable.Cell>
      ...
      >
        <Header>
          Add students to <strong>{currentAccountHolder}</strong>
        </Header>
        <Modal.Content>
